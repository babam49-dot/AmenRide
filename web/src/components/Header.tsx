...
import { PickupLocationPickerModal } from './PickupLocationPickerModal';

export const Header: React.FC = () => {
  const { language, toggleLanguage, t } = useLanguage();
  const { role, setRole, setIsSearchOpen } = useRole();
  const [isPickupPickerOpen, setIsPickupPickerOpen] = useState(false);
  const [selectedPickup, setSelectedPickup] = useState('Felege Hiwot Square');
